...
public class CeuesrTestContainer extends TestContainer {

    public CeuesrTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/ceuesr/app.properties",
    ...
    public static class Common extends CeuesrTestContainer {

        public static final CeuesrTestContainer.Common INSTANCE = new CeuesrTestContainer.Common();
